                ...
                {eventos.map((evento) => (
                  <div key={evento.evento_id} className="tech-card p-6 hover:scale-[1.02] transition-transform" style={{ borderColor: `${colors.primario}30` }}>
                    <div className="flex flex-col gap-4">
                      ...
                      <div>
                        <span className="inline-block px-3 py-1 rounded-full text-xs font-bold text-white mb-2" style={{ backgroundColor: colors.secundario }}>{evento.tipo_evento || 'Evento'}</span>
